...
def remove_attr(content: str, attr: str) -> tuple[str, int]:
...
def main() -> int:
    ...
    updated, removed_count = remove_attr(original, args.attr)
    ...
    print(f"[{status}] attr={args.attr} removed={removed_count} file={target}")
    return 0
